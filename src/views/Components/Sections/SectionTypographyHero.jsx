          ...
          <GridContainer >
            <div className={classes.typo}>
              <div className="titleHolder">
                ...
                <h2 className='avatitle'>Обучение игре на барабанах детей и взрослых.</h2>

              </div>
             <div className="mainText">
               <h4 className={classes.title}>
                 Индивидуальные занятия, мастер-классы, тренинги, специальные сессии
               </h4>
               <h4 className={classes.title}>
               ...
               <div className={classes.typo}>
                 <Quote
                   text="Свою методику я называю барабанной йогой, поскольку игра на барабанах это искусство быть расслабленным и уметь осознанно управлять своим телом. Это внутренняя дисциплина, которая позволяет концентрироваться, удерживать внимание в нескольких направлениях, находясь в потоке ритма"
